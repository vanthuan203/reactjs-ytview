...
const OrderItem: React.FC<Props> = ({ item, showEdit, index }) => {
    ...
    return (
        <tr style={{margin:100,backgroundColor:item.balance>0?"rgba(252,226,207,0.62)":"#ffffff"}}>
            ...
            <td>
                <span >
                    <text style={{fontSize:12,fontWeight:"bold",color:item.service>2000?"rgba(72,67,239,0.97)":item.service>1000?"rgba(3,37,80,0.97)":(item.service<600?"rgba(34,126,231,0.97)":"#b7080f")}}>
                        {item.service}
                    </text>
                            </span>
            </td>
