...
const WidgetsPage: React.FC = () => {
  ...
  const orders: OrderModel[] = useSelector<RootState>(({ ordersmmhistory }) => ordersmmhistory.orders, shallowEqual) as OrderModel[] || []
  const currentOrder: OrderModel = useSelector<RootState>(({ ordersmmhistory }) => ordersmmhistory.currentOrder, shallowEqual) as OrderModel || undefined
  let role: string =
