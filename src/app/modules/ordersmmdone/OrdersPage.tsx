...
const WidgetsPage: React.FC = () => {
    ...
    const currentOrder: OrderModel = useSelector<RootState>(({ ordersmmdone }) => ordersmmdone.currentOrder, shallowEqual) as OrderModel || undefined
    ...
    async function getnow(){
        const requestUrl = API_URL+'balance/fluctuationsMobile';
        const response= await fetch(requestUrl,{
            method: 'get',
            headers: new Headers({
                'Authorization': 'api@gmail.com',
    ...
    async function get5M(){
        const requestUrl = API_URL+'balance/fluctuations5M';
        const response= await fetch(requestUrl,{
            method: 'get',
            headers: new Headers({
                'Authorization': 'api@gmail.com',
