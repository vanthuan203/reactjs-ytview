...
const OrderList: React.FC<Props> = ({done,className, orders}) => {
  ...
  const clickUpdatePriority = () => {
    ...
    const orderarr=arr.join(',')
    if (window.confirm("Bạn chắc chắn muốn ưu tiên "+arr.length+" đơn!") == true) {
      dispatch(actions.requestUpdatePriority(orderarr))
    }
    setChecked(false)
    dispatch(actions.checkedAllChange(false))
  }
            ...
            <div className="align-items-center row" style={{marginTop:10,marginBottom:10,marginRight:5,marginLeft:5}}>
             <div className="col-lg-7 col-sm-12 c-order__header">
                ...
                <span  className='fw-bolder fs-3 mb-1'>
                  <span className='badge badge-success 1' style={{fontSize:12,color:"#090909",backgroundColor:"rgb(255,255,255)",marginLeft:5}}>{"Order Running " +total_Order_Running_Show} </span>
                </span>
              ...
              <div className="col-lg-5 col-sm-12 text-right">
                ...
                {isShowFixMulti&& role === "ROLE_ADMIN"&& (
                    <button style={{margin:5,backgroundColor:"rgba(20,122,178,0.66)"}}
                        onClick={() => {
                          clickUpdatePriority()
                        }}
          ...
          <div className='table-responsive'>
            ...
            <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
              ...
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-70px text-sm'>
                ...
                {role!="ROLE_USER"&&<th className='min-w-70px text-sm'>
