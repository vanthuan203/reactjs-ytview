...
export const actionTypes = {
  ShowOrdersFilter:'[OrderSmmdone] Filter',
  ShowOrdersPercentFilter:'[OrderSmmdone] Percent Filter',
  RequestOrders: '[OrderSmmdone] Requested',
  OrdersLoadedSuccess: '[OrderSmmdone] Loaded succcess',
  OrdersLoadedFail: '[OrderSmmdone] load fail',
  AddOrderRequest: '[OrderSmmdone] Add OrderSmm Request',
  AddOrderManualRequest: '[OrderSmmdone] Add OrderSmm Manual Request',
  AddOrderSuccess: '[OrderSmmdone] Add OrderSmm Success',
  AddOrdersSuccess: '[OrderSmmdone] Add OrdersSmm Success',
  AddOrderFail: '[OrderSmmdone] Add OrderSmm Fail',
  ShowcurrentOrder: '[OrderSmmdone] Show OrderSmm',
  RequestUpdate: '[OrderSmmdone] Requested  Update',
  RequestUpdateThread: '[OrderSmmdone] Requested UpdateThread',
  RequestUpdatePriority: '[OrderSmmdone] Requested UpdatePriority',
  UpdateMultiOrderRequest: '[OrderSmmdone] Update Multi OrderSmm Request',
  UpdateMultiThreadRequest: '[OrderSmmdone] Update Multi Thread Request',
  UpdateSuccess: '[OrderSmmdone] Update Success',
  UpdateMultiSuccess: '[OrderSmmdone] Update Multi Success',
  UpdateFail: '[OrderSmmdone] Update Fail',
  ClearSelected: '[OrderSmmdone] Clear selected account',
  GroupLoadedRequest: '[OrderSmmdone] Group Loaded Request',
  GroupLoadedSuccess: '[OrderSmmdone] Group Loaded Success',
  GroupLoadedFail: '[OrderSmmdone] Group Loaded Fail',
  GroupAddRequest: '[OrderSmmdone] GroupAddRequest',
  GroupAddSuccess: '[OrderSmmdone] Group Add Success',
  GroupAddFail: '[OrderSmmdone] Group Add Fail',
  GroupDeleteRequest: '[OrderSmmdone] Group Delete Request',
  GroupDeleteSuccess: '[OrderSmmdone] Group Delete Success',
  SelectGroup: '[OrderSmmdone] Select Group',
  DeleteOrderRequest: '[OrderSmmdone] Delete OrderSmm Request',
  DeleteOrderSuccess: '[OrderSmmdone] Delete OrderSmm Success',
  CheckedChange: '[OrderSmmdone] Checked Change',
  CheckedAllChange: '[OrderSmmdone] Checked All Change',
}
...
export const reducer = persistReducer(
  ...
  (state: Iorderstate = initialorderstate, action: ActionWithPayload<any>) => {
    switch (action.type) {
      ...
      case actionTypes.RequestUpdatePriority: {
        return {
          ...state,
          loading: true
        }
...
export const actions = {
  ...
  editMultiThreadRequest: (data: OrderUpdateForm) => ({ type: actionTypes.UpdateMultiThreadRequest, payload: { data } }),
  ...
  requestUpdatePriority: (order_id: string) => ({ type: actionTypes.RequestUpdatePriority, payload: { order_id } }),
...
export function* saga() {
  ...
  yield takeLatest(actionTypes.RequestUpdatePriority, function* updateUserRequested(param: any) {
    const payload = param.payload
    const { data: result } = yield updatePriority(payload.order_id)
    if (result && result.order_running) {
      yield put(actions.updateMultiSuccess(result.order_running))
    } else {
      alert(result.message)
