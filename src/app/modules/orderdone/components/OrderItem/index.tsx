        ...
        <tr style={{margin:100,backgroundColor:item.checked==true?"rgba(252,226,207,0.62)":""}}>
            ...
            <td>
                ...
                <span>
                    ...
                    {(item.viewtotal>0)&&<span style={{ color:'white',fontSize:11,backgroundColor:Math.round((Math.round(Number(item.viewtotal==null?0:item.viewtotal))/item.vieworder*100))>=100?"rgba(234,100,100,0.97)":"#26695c",marginRight:5,marginBottom:5}} className='badge badge-success 1'><span style={{color:"#fafafa"}}>{Math.round((Math.round(Number(item.viewtotal==null?0:item.viewtotal))/item.vieworder*100))+'%'}</span></span>}
                    {(item.view24h>=0)&&<span style={{ color:'white',fontSize:11,backgroundColor:(((item.view24h-item.viewstart)>=item.viewtotal)&&(item.view24h>=0))?"rgba(208,21,21,0.97)":((item.view24h-item.viewstart<=0)&&(item.view24h>=0))?"rgb(46,47,46)":"rgba(34,126,231,0.97)",marginRight:5,marginBottom:5}} className='badge badge-success 1'>Current <span style={{color:"white"}}>{item.view24h==null?0:item.view24h}</span></span>}
                    {(item.view24h>=0)&&<span style={{ color:'white',fontSize:11,backgroundColor:(((item.view24h-item.viewstart)>=item.viewtotal)&&(item.view24h>=0))?"rgba(208,21,21,0.97)":((item.view24h-item.viewstart<=0)&&(item.view24h>=0))?"rgb(46,47,46)":"rgba(34,126,231,0.97)",marginRight:5,marginBottom:5}} className='badge badge-success 1'><span style={{color:"#fafafa"}}>{Math.round((Math.round(Number((item.view24h-item.viewstart)==null?0:(item.view24h-item.viewstart)))/item.vieworder*100))+'%'}</span></span>}
