...
const WidgetsPage: React.FC = () => {
  ...
  const orders: OrderModel[] = useSelector<RootState>(({ ordersmmhistoryfind }) => ordersmmhistoryfind.orders, shallowEqual) as OrderModel[] || []
  const currentOrder: OrderModel = useSelector<RootState>(({ ordersmmhistoryfind }) => ordersmmhistoryfind.currentOrder, shallowEqual) as OrderModel || undefined
